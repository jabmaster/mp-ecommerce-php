                            ...
                            <div class="width:60%">
                                ...
                                <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                    ...
                                    <form method="POST" action="checkout.php">
                                        ...
                                        <input type="hidden" name="product_name" value="<?=$_POST['title']?>"/>
                                        <input type="hidden" name="product_quantity" value="<?=$_POST['unit']?>"/>
                                        <input type="hidden" name="product_price" value="<?=$_POST['price']?>"/>
                                        <input type="hidden" name="product_img" value="<?=$_POST['img']?>"/>
